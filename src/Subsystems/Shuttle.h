...
class Shuttle {
   public:
    /**
     * These are the states that the tensioning arms can be at during operation.
     */
    enum ArmPosition {
        kLeftArmRaised,
        kRightArmRaised,
     ...
     */
    bool ArmTransition(ArmPosition pos);
     ...
     */
    void SetTensionArms(double leftArmAngle, double rightArmAngle);
